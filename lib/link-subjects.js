...
const updateSubjectMetadata = require('./update-subject-metadata');
...
exports.handler = function (argv) {
  handleLogin(argv.prompt, function(user) {
    ...
    getAllSubjectsInSet(argv.subjectSet).then( function(subjects) {
      ...
      prompt.get([{
        properties: {
          proceed: {
            description: 'This will modify ' + updatedSubjects.length + ' existing subjects. Are you sure? (y/n)'
          }
        }
      }], function(err, res) {
